...
fn _arc(x: i32, y: i32, radius: i32, start: f64, end: f64, r: u8, g: u8, b: u8) { _BUF.lock().unwrap().push(format!(r#"{{"draw":"arc","x":{},"y":{},"radius":{},"start":{},"end":{},"r":{},"g":{},"b":{},"a":255}}"#, x, y, radius, start, end, r, g, b)); }
